...
module.exports = new (class {
  ...
  script = (payload, context) => {
    ...
    if (context.task.source === 'ignore') {
      ...
      Mesa.log.warn(
        `Conditions (${Filter.stringify(a, b, comparison, additional)}) did not pass, stopping execution`
      );
