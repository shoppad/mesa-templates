...
module.exports = new (class {
  ...
  createWorkflow = action => {
    ...
    if (
      ...
      if (action === 'update') {
        webhookPayload =
          '\n{\n    "name": "Mesa Contact Updated",\n    "type": "DRIP_DELAY",\n    "onlyEnrollsManually": false,\n    "actions": [\n        {\n            "type": "WEBHOOK",\n            "method": "POST",\n            "url": "https://webhooks.getmesa.com/dev/shoppad-john/json/create-shopify-customer-from-hubspot-contact/in-hubspot-contact-created.json?apikey=X2wnbIzIND7mBQf2J4UDv34lqK5Qewr1zDzPVwFe"\n        }\n    ], \n    "segmentCriteria": [\n        [\n            {\n                "filterFamily": "PropertyValue",\n                "withinTimeMode": "PAST",\n                "operator": "CONTAINS",\n                "property": "email",\n                "value": "john_230@hotmail.com;john+hubspot",\n                "type": "string"\n            },\n            {\n                "filterFamily": "PropertyValue",\n                "withinTimeMode": "PAST",\n                "operator": "IS_NOT_EMPTY",\n                "property": "firstname",\n                "type": "string"\n            },\n            {\n                "compareProperty": "createdate",\n                "filterFamily": "PropertyValue",\n                "withinTimeMode": "PAST",\n                "operator": "GT",\n                "property": "lastmodifieddate",\n                "type": "datetime"\n            }\n        ],\n        [\n            {\n                "filterFamily": "PropertyValue",\n                "withinTimeMode": "PAST",\n                "operator": "CONTAINS",\n                "property": "email",\n                "value": "john_230@hotmail.com;john+hubspot",\n                "type": "string"\n            },\n            {\n                "filterFamily": "PropertyValue",\n                "withinTimeMode": "PAST",\n                "operator": "IS_NOT_EMPTY",\n                "property": "lastname",\n                "type": "string"\n            },\n            {\n                "compareProperty": "createdate",\n                "filterFamily": "PropertyValue",\n                "withinTimeMode": "PAST",\n                "operator": "GT",\n                "property": "lastmodifieddate",\n                "type": "datetime"\n            }\n        ]\n    ],\n    "allowContactToTriggerMultipleTimes": true,\n    "reEnrollmentTriggerSets": [\n        [\n            {\n                "id": "firstname",\n                "type": "CONTACT_PROPERTY_NAME"\n            }\n        ],\n        [\n            {\n                "id": "lastname",\n                "type": "CONTACT_PROPERTY_NAME"\n            }\n        ]\n    ],    \n    "enabled": true\n}';
      }
