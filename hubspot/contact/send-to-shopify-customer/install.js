...
module.exports = new (class {
  ...
  createWorkflow = action => {
    ...
    if (
      ...
      let webhookPayload =
        '{"name":"Mesa Contact Created","type":"DRIP_DELAY","onlyEnrollsManually":false,"actions":[{"type":"WEBHOOK","method":"POST","url":"{webhook_url}"}],"segmentCriteria":[[{"filterFamily":"PropertyValue","withinTimeMode":"PAST","operator":"IS_NOT_EMPTY","property":"hs_object_id","type":"number"},{"filterFamily":"PropertyValue","withinTimeMode":"PAST","operator":"NEQ","property":"hs_analytics_source_data_1","value":"API","type":"string"}]],"reEnrollmentTriggerSets":[],"enabled":true}';

      if (action === 'update') {
        webhookPayload =
          '{"name":"Mesa Contact Updated","type":"DRIP_DELAY","onlyEnrollsManually":false,"actions":[{"type":"WEBHOOK","method":"POST","url":"{webhook_url}"}],"segmentCriteria":[[{"filterFamily":"PropertyValue","withinTimeMode":"PAST","operator":"IS_NOT_EMPTY","property":"firstname","type":"string"},{"compareProperty":"createdate","filterFamily":"PropertyValue","withinTimeMode":"PAST","operator":"GT","property":"lastmodifieddate","type":"datetime"}],[{"filterFamily":"PropertyValue","withinTimeMode":"PAST","operator":"IS_NOT_EMPTY","property":"lastname","type":"string"},{"compareProperty":"createdate","filterFamily":"PropertyValue","withinTimeMode":"PAST","operator":"GT","property":"lastmodifieddate","type":"datetime"}]],"allowContactToTriggerMultipleTimes":true,"reEnrollmentTriggerSets":[[{"id":"firstname","type":"CONTACT_PROPERTY_NAME"}],[{"id":"lastname","type":"CONTACT_PROPERTY_NAME"}]],"enabled":true}';
      }
