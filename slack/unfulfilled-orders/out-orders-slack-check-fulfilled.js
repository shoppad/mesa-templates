...
module.exports = new class {
  ...
  script = (payload, context) => {
    ...
    if (order.fulfillment_status === 'fulfilled') {
      Mesa.log.info(`Order ${order.name} is fulfilled, no further action necessary`, order.fulfillment_status);
    }

    // Order is not fulfilled, so send a slack message
    else if (order.fulfillment_status === null || order.fulfillment_status !== 'fulfilled') {
